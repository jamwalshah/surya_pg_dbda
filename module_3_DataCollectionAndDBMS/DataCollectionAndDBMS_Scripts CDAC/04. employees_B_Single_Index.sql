CREATE TABLE IF NOT EXISTS `employees_B_Single` (
...
--
-- Dumping data for table `employees_B_Single`
--

INSERT INTO `employees_B_Single` (`EMPLOYEE_ID`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `PHONE_NUMBER`, `HIRE_DATE`, `JOB_ID`, `SALARY`, `COMMISSION_PCT`, `MANAGER_ID`, `DEPARTMENT_ID`) VALUES
