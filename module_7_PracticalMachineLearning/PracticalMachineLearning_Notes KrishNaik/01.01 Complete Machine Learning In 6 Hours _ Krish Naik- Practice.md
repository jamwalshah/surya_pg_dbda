...
- Example
  - Lets say I have two actual data points, and I draw the besr fit line which passes through these two data points and through origin, so ${J(θ_1)=0}$ because best fit line passes through origin
  ...
  - But, this is a case of overfitting and I have to ensure that the cost function doesn't become zero, this is where Ridge Regression comes into picture
  - 
