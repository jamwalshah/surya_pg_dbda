...
- This equation of line/linear regression is also represented by
  - y     = β₀ + β₁x
  - ![h_{\theta} (https://arachnoid.com/latex/?equ=h_%7B%5Ctheta%7D)](../../content/h_theta17x21.png)x = θ₀ + θ₁x
    - it is Linear Hypothesis or linear regression model equation where
      - 'y' or ![h_{\theta} (https://arachnoid.com/latex/?equ=h_%7B%5Ctheta%7D)](../../content/h_theta17x21.png)
...
- As per Andrew NG, the equation of a straight line is
  - y = mx⁽ⁱ⁾ + c
  - y = β₀ + β₁x⁽ⁱ⁾
  - ![h_{\theta} (https://arachnoid.com/latex/?equ=h_%7B%5Ctheta%7D)](../../content/h_theta17x21.png)x⁽ⁱ⁾ = θ₀ + θ₁x⁽ⁱ⁾
