...
1. If 'θ₀' = 0
    ...
    - Now, keeping the y-intercept 'θ₀' = 0, and changing the value of slope/coefficient 'θ₁'
      ...
      2. if 'θ₁' = 0.5
          ...
          - ![Cost-Function-Theta0-0-Theta1-0.5-2-{=\frac{1}{2\times3}[(0.5-1)^2+(1-2)^2+(1.5-3)^2]}(https://latex.codecogs.com/svg.image?{=\frac{1}{2\times3}[(0.5-1)^2&plus;(1-2)^2&plus;(1.5-3)^2]})](../../content/Cost-Function-Theta0-0-Theta1-0.5-2-{=_frac{1}{2_times3}[(1-1)^2+(2-2)^2+(3-3)^2]}.svg)
